...
import (
	...
	"github.ibm.com/watson-foundation-services/cp4d-audit-webhook-operator/controllers"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "10037de4.watson.ibm.com",
	})
	if err != nil {
	...
	if err = (&controllers.AuditWebhookReconciler{
		Client: mgr.GetClient(),
		Log:    ctrl.Log.WithName("controllers").WithName("AuditWebhook"),
		Scheme: mgr.GetScheme(),
		Config: mgr.GetConfig(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "AuditWebhook")
		os.Exit(1)
	}
